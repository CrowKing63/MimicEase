 ...
 *
 * Cold Start 처리:
 * - 브로드캐스트 전송 후 ToggleBroadcastReceiver가 cold start 대응 로직 수행
 * - 실패 시 사용자에게 Toast 피드백 제공
 */
class ToggleActionActivity : ComponentActivity() {
    ...
    private fun handleIntent(intent: Intent?) {
        ...
        try {
            ...
            Timber.e(e, "ToggleActionActivity: 브로드캐스트 전송 실패")
            showFeedback("MimicEase 제어 실패")
        }
    }
